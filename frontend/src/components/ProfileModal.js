...
import { FiCamera, FiX, FiLock, FiUser, FiEdit2, FiLogOut, FiSun, FiMoon, FiSave, FiTrash2 } from 'react-icons/fi';
...
function ProfileModal({ onClose }) {
  ...
  const deleteAccount = async () => {
    if (window.confirm('⚠️ WARNING: This will permanently delete your account and all your messages. This action cannot be undone! Are you sure?')) {
      setLoading(true);
      try {
    ...
    >
      ...
      >
        ...
        <div className="profile-footer">
          <button onClick={deleteAccount} className="delete-account-btn" disabled={loading}>
